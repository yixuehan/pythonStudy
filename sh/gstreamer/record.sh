...
gst-launch-1.0 -e mp4mux name=mux ! filesink location=file.mp4 v4l2src ! queue ! "video/x-raw, format=(string)YUY2, width=(int)640, height=(int)480, pixel-aspect-ratio=(fraction)1/1, framerate=(fraction)30/1" ! videoconvert ! x264enc tune=zerolatency ! mux. alsasrc ! queue ! voaacenc ! mux.
