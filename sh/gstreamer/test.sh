...
gst-launch-1.0 -e qtmux name=mux ! filesink location="record.mp4" sync=false \
             v4l2src ! queue ! decodebin ! videoconvert ! x264enc tune=zerolatency ! mux. \
             alsasrc ! queue ! decodebin ! audioconvert ! audioresample ! voaacenc ! mux.
